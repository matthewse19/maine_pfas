...
# Load the Excel data
df = pd.read_csv(
    "https://raw.githubusercontent.com/matthewse19/maine_pfas/main/cleaned_data.csv"
)
...
geojson_data = gpd.read_file(
    "https://raw.githubusercontent.com/matthewse19/maine_pfas/main/geojson_maine_towns.json"
)
...
app_ui = ui.page_fluid(
    ...
    ui.panel_well(
        ...
        EPA and Maine DEP respestively.
        """
        ),
        ui.p(
